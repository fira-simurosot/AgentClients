# Download and edit from https://github.com/osechet/conan-grpc/blob/master/FindgRPC.cmake
...
function(GRPC_GENERATE_CPP SRCS HDRS)
    ...
    if(DEFINED GRPC_IMPORT_DIRS)
        foreach(DIR ${GRPC_IMPORT_DIRS})
            ...
            list(FIND _grpc_include_path ${ABS_PATH} _contains_already)
            if(${_contains_already} EQUAL -1)
                list(INSERT _grpc_include_path 0 -I ${ABS_PATH})
            endif()
        endforeach()
    endif()
    ...
    foreach(FIL ${PROTO_FILES})
        ...
        if(NOT GRPC_GENERATE_CPP_APPEND_PATH)
            ...
            list(GET _grpc_include_path 1 FIL_ROOT)
            file(RELATIVE_PATH FIL_DIR ${FIL_ROOT} ${FIL_DIR})
            if(FIL_DIR)
